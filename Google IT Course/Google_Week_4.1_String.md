...
# 2. Using the format method, fill in the gaps in the convert_distance function so that it returns the 
# phrase "X miles equals Y km", with Y having only 1 decimal place.
###   ###   ###
...
# 3. Fill in the gaps in the nametag function so that it uses the format method to return first_name 
