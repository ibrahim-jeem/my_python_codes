<> This is the assisment of Course 6 week 3
...
#### Output:
   ...
   ![output 1](/Google%20IT%20Course/Module%206/img/output_1.png)
...
#### Output:
  ...
  ![output2](/Google%20IT%20Course/Module%206/img/output_2.png)

    cat ~/scripts/emails.py

#### Output:

  ![output3](/Google%20IT%20Course/Module%206/img/output_3.png)
...
Here, you'll need a login to roundcube using the username and password mentioned in the Connection Details Panel on the left hand side, followed by clicking Login.
  ...
  ![output4](/Google%20IT%20Course/Module%206/img/output_4.png)
...
#### Output:
  ...
  ![output5](/Google%20IT%20Course/Module%206/img/output_5.png)
...
Now, check the webmail for any new mail. You can click on the Refresh button to refresh your inbox.
  ...
  ![output6](/Google%20IT%20Course/Module%206/img/output_6.png)
...
#### Output:
  ...
  ![output7](/Google%20IT%20Course/Module%206/img/output_7.png)
...
#### Output:
  ...
  ![output8](/Google%20IT%20Course/Module%206/img/output_8.png)

Open cars.pdf that's located on the right most side.

  ![output9](/Google%20IT%20Course/Module%206/img/output_9.png)
...
# Fnal Code given below
        ...
        def process_data(data):
          ...
          popular_car_year_sorted = sorted(popular_car_year.items(), key=lambda a: a[1], reverse=True)

          summary = [
            "The {} generated the most revenue: ${}".format(
              format_car(max_revenue["car"]), max_revenue["revenue"]),
            "The {} had the most sales: {}".format(max_sales['car_model'], max_sales['total_sales']),
            "The most popular year was {} with {} sales.".format(popular_car_year_sorted[0][0], popular_car_year_sorted[0][1]),
          ]
        ...
        def main(argv):
          ...
          message = emails.generate("automation@example.com", "student-id@example.com", "Sales summary for last month", "\n".join(summary), "/tmp/cars.pdf")
          emails.send(message)
